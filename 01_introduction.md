...
$$
|\psi\rangle_{\text{高维信息}}\xrightarrow{\text{经典化难度高}} I_{\text{经典知识}}+S_{\text{经典熵}}
$$

$$
|\psi\rangle_{\text{低维信息}}\xrightarrow{\text{经典化难度低}} I_{\text{经典知识}}+S_{\text{经典熵}}
$$
...
- Classicalization difficulty of **High-dimensional Information** and **Low-dimensional Information**:

$$
|\psi\rangle_{\text{High-dimensional Information}}\xrightarrow{\text{High Classicalization Difficulty}} I_{\text{Classical Knowledge}}+S_{\text{Classical Entropy}}
$$

$$
|\psi\rangle_{\text{Low-dimensional Information}}\xrightarrow{\text{Low Classicalization Difficulty}} I_{\text{Classical Knowledge}}+S_{\text{Classical Entropy}}
$$
