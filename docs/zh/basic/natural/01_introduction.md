...
本文是[量子经典二元论核心理论](../../core/natural/core.md)（版本35.0）的简介。

### 理论背景

量子经典二元论是一种全新的宇宙结构解释框架，提出宇宙本质上由两个域构成：**量子域**(混沌)与**经典域**(现实确定)。这两个域通过**观察者经典化解码**(能量)过程相互联系，形成完整统一的宇宙信息结构(无限可能)。
...
1. [核心理论](../../core/natural/core.md) - 理论的完整阐述(版本35.0)
...
This document is an introduction to the [Quantum-Classical Dualism Core Theory](../../core/natural/core.md) (Version 35.0).
...
1. [Core Theory](../../core/natural/core.md) - Complete exposition of the theory (Version 35.0)
